...
function(zeron_copy_assets target outputDir)
    ...
    add_custom_command(
        TARGET ${target} 
        POST_BUILD
        COMMAND ${CMAKE_COMMAND} -E echo "Copying Zeron assets to '$<TARGET_FILE_DIR:${target}>/${outputDir}' directory..."
        COMMAND ${CMAKE_COMMAND} -E copy_directory "${assets_dir}" "$<TARGET_FILE_DIR:${target}>/${outputDir}"
    )
endfunction()
