...
namespace ZeronEngine{ namespace GLFWHelpers
{
	...
	MouseCode GetMouseCodeFromGLFW(int MouseCodeGLFW)
	{
		switch (MouseCodeGLFW)
		{
			...
			case GLFW_MOUSE_BUTTON_4:		return MouseCode::Button3;
			case GLFW_MOUSE_BUTTON_5:		return MouseCode::Button4;
	...
	KeyCode GetKeyCodeFromGLFW(int KeyCodeGLFW)
	{
		switch (KeyCodeGLFW)
		{
