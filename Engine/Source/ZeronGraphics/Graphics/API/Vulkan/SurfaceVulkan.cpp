...
#	if ZE_PLATFORM_WIN32
		const VkWin32SurfaceCreateInfoKHR surfaceInfo = {
			VK_STRUCTURE_TYPE_WIN32_SURFACE_CREATE_INFO_KHR, nullptr, 0, GetModuleHandle(nullptr), static_cast<HWND>(systemHandle.mWindow)
		};
...
#	elif ZE_PLATFORM_LINUX
		const VkXlibSurfaceCreateInfoKHR surfaceInfo = {
			VK_STRUCTURE_TYPE_XLIB_SURFACE_CREATE_INFO_KHR, nullptr, 0, reinterpret_cast<Display*>(systemHandle.mConnection), systemHandle.mWindow
		};
...
#	elif ZE_PLATFORM_ANDROID
		const VkAndroidSurfaceCreateInfoKHR surfaceInfo = {
			VK_STRUCTURE_TYPE_ANDROID_SURFACE_CREATE_INFO_KHR, nullptr, 0, reinterpret_cast<ANativeWindow*>(systemHandle.mWindow)
		};
